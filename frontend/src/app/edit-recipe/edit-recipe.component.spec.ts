...
describe('EditRecipeComponent', () => {
  ...
  component.doughs = signal([{ _id: '1', name: 'flaky pastry' } as Dough]);
  ...
  it('should update dough on saveEdit when component is dough', () => {
    component.component = signal('dough');
    component.id = signal('123');
    component.doughName = signal('New Dough');
    component.doughIngredients = signal('10 g sugar\n1 g salt');
  ...
  it('should log error on updateDough failure', () => {
    ...
    component.component = signal('dough');
    component.id = signal('123');
    component.doughName = signal('Error Filling');
    component.doughIngredients = signal('10 g cocoa');
  ...
  it('should update filling on saveEdit when component is filling', () => {
    component.component = signal('filling');
    component.id = signal('123');
    component.fillingName = signal('New Filling');
    component.fillingIngredients = signal('50 g chocolate\n5 g butter');
  ...
  it('should return filling name when filling is found', () => {
    component.fillings = signal([{ _id: '1', name: 'chocolate' } as Filling]);
  ...
  component.component = signal('filling');
  component.id = signal('123');
  component.fillingName = signal('Error Filling');
  component.fillingIngredients = signal('10 g cocoa');
  component.fillingInstructions = signal('Stir well');
  ...
  it('should update topping on saveEdit when component is topping', () => {
    component.component = signal('topping');
    component.id = signal('t123');
    component.toppingName = signal('New Topping');
    component.toppingIngredients = signal('15 ml syrup\n2 g nuts');
  ...
  it('should return topping name when topping is found', () => {
    component.toppings = signal([{ _id: '1', name: 'chocolate' } as Topping]);
  ...
  it('should log error on updateTopping failure', () => {
    ...
    component.component = signal('topping');
    component.id = signal('123');
    component.toppingName = signal('Error topping');
    component.toppingIngredients = signal('10 g cocoa');
    component.toppingInstructions = signal('Stir well');
...
it('should return "Unbekannte Komponente" for unknown component type', () => {
  ...
  it('should update cake on saveEdit when component is cake', () => {
    ...
    component.cakeName = signal('Updated Cake');
